    ...
    <div>
      <div className="flex flex-col justify-between min-h-screen ">
        <div className="text-center flex flex-col justify-around mt-24 md:mt-4">
          {subscriptionInfo && (
            <div className="flex flex-col md:flex-row mx-auto w-full justify-between md:justify-center  min-h-96 md:items-start  ">
              <div className="bg-accent md:w-1/3 border border-purple-400 rounded-3xl shadow-2xl text-white md:mx-12 mt-12 md:mt-0  mx-4 sm:mx-0  ">
